...
- **Limitação conhecida:** como a data real da matrícula original dos 24 alunos migrados se perdeu no reset (o `created_at` das matrículas reflete a data da reconstrução do banco, 17/07/2026, não a matrícula real de cada aluno), a contagem de 60 dias desses alunos específicos começou a contar a partir da reconstrução, não da matrícula histórica real. Se Diego souber as datas reais de matrícula desses 24 alunos, dá pra corrigir manualmente por CTR.
