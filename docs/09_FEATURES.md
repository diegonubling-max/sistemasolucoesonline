...
- ✅ Ícone 💲 (vermelho, ao lado do nome) quando o aluno não tem nenhuma parcela cadastrada em nenhuma matrícula — sinaliza financeiro pendente de configurar. Legenda dos ícones (vitrine, financeiro) fixada acima da tabela (05/08/2026) — removida a bolinha verde/vermelha ao lado do nome (redundante com a coluna Status/Badge Ativo-Inativo já existente)
