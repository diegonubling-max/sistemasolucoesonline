...
- ✅ **(25/08/2026) Boleto: PIX de entrada agora cobra taxa + 1ª parcela juntas** — antes o botão verde do boleto gerava um PIX só da taxa de matrícula (R$69,90); agora gera R$229,80 (R$69,90 taxa + R$159,90 da 1ª parcela), cobrados numa cobrança só. Card de seleção de pagamento mostra o texto explicando ("Taxa de matrícula de R$69,90 + 1+9 parcelas de R$159,90")
