...
CREATE OR REPLACE FUNCTION public.criar_matricula_lancamento(
  ...
  p_contrato_html TEXT DEFAULT NULL,
  p_assinatura_nome TEXT DEFAULT NULL
)
...
GRANT EXECUTE ON FUNCTION public.criar_matricula_lancamento(TEXT, TEXT, TEXT, TEXT, DATE, TEXT, UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT) TO anon, authenticated;
